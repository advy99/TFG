...
% TODO: cambiar cita
El algoritmo que utilizaremos, SMOGN \cite{BL-SMOTE}, se basa en distintas variantes de SMOTE \cite{SMOTE}, donde se mejora el algoritmo original y se adapta a regresión.
