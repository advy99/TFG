...
\textbf{GA-P: Longitud máxima 40} & \textbf{75,86876}                & \textbf{8,704602}                & \textbf{7,226134}               & 499,1296\\ \hline
...
\textbf{GA-P: Longitud máxima 20} & \textbf{71,10252}                & \textbf{8,425564}                & 6,93037                & 283,6592\\ \hline
\textbf{GA-P: Longitud máxima 40} & 71,65424                & 8,457206                & \textbf{6,920638}               & 517,811\\ \hline
...
\textbf{PG: Longitud máxima 60}   & \textbf{71,4802}                 & \textbf{8,450386}                & \textbf{6,94271}                & 940,1766\\ \hline
...
\textbf{GA-P: Longitud máxima 40} & \textbf{62,47418}                & \textbf{7,90087}                 & \textbf{6,43548}                & 635,3626\\ \hline
...
\textbf{GA-P: Longitud máxima 60} & \textbf{67,57086}                & \textbf{8,214506}                & \textbf{6,769916}               & 882,5354\\ \hline
\end{tabular}%
}
...
\textbf{PG: Longitud máxima 60}   & \textbf{62,2492}                 & \textbf{7,887122}                & \textbf{6,465792}               & 1245,464\\ \hline
...
\begin{tabular}{|c|c|c|}
\hline
\multicolumn{3}{|c|}{\textbf{Mejores resultados de nuestra propuesta}}        \\ \hline
\textbf{}                                     & \textbf{RECM} & \textbf{MAE} \\ \hline
\textbf{PG: L. izquierda}                     & 8,531        & 7,076        \\ \hline
\textbf{PG: L. derecha}                       & 8,214        & 6,738        \\ \hline
\textbf{PG: Completo}                         & 8,398        & 6,920        \\ \hline
\textbf{GA-P: L. izquierda}                   & 8,565        & 7,111        \\ \hline
\textbf{GA-P: L. derecha}                     & 8,205        & 6,703        \\ \hline
\textbf{GA-P: Completo}                       & 8,494        & 6,967        \\ \hline
\textbf{PG: L. izquierda (sobremuestreo)}     & 7,864        & 6,394        \\ \hline
\textbf{PG: L. derecha (sobremuestreo)}       & 7,984        & 6,559        \\ \hline
\textbf{PG: Completo (sobremuestreo)}         & 7,866        & 6,412        \\ \hline
\textbf{GA-P: L. izquierda (sobremuestreo)}   & 7,894        & 6,445        \\ \hline
\textbf{GA-P: L. derecha (sobremuestreo)}     & 8,110        & 6,708        \\ \hline
\textbf{GA-P: Completo (sobremuestreo)}       & 7,871        & 6,423        \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}PG: L. izquierda (sobremuestreo, \\ validación con datos originales)\end{tabular}}     & 7,874         & 6,641        \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}PG: L. derecha (sobremuestreo, \\ validación con datos originales)\end{tabular}}       & 8,121         & 6,863        \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}PG: completo (sobremuestreo, \\ validación con datos originales)\end{tabular}}         & 8,147         & 6,689        \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}GA-P: L. izquierda (sobremuestreo, \\ validación con datos originales)\end{tabular}}   & 8,005         & 6,623        \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}GA-P: L. derecha (sobremuestreo, \\ validación con datos originales)\end{tabular}}     & 7,974         & 6,641        \\ \hline
\textbf{\begin{tabular}[c]{@{}c@{}}GA-P: Completo (sobremuestreo, \\ validación con datos originales)\end{tabular}}       & 7,882         & 6,586        \\ \hline
\end{tabular}%
% }
\caption{Mejores resultados obtenidos en este trabajo.}\label{table:mejores_resultados}
\end{table}
...
Por otro lado, en los distintos trabajos mencionados en el estado del arte se consiguen los siguientes resultados:
...
\textbf{Sauchey \& Brooks \cite{sucheyBrooks}}                                             & 739                         & 17.15         & -            \\ \hline
\textbf{Slice \& Algee-Hewitt \cite{modelandoHuesos3D}}                                    & 41                          & 17.15         & -            \\ \hline
\textbf{Stoyanova,  Algee-Hewitt, Kim \& Slice \cite{mejoraModelandoHuesos3D}}             & 93                          & 13.7 - 16.5   &              \\ \hline
